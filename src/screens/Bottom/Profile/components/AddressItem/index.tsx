...
const AddressItem = ({item, onDelete}: {item: IAddress; onDelete:(address:IAddress)=>void}) => {
      ...
      <View style={styles.allTextContainer}>
        ...
        <View>
          <View>
            ...
            <Text><Text style={styles.subTitleText}>Floor Number: </Text>{item?.floorNumber}</Text>
